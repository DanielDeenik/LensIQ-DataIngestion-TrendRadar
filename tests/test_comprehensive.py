...
class TestComprehensive(unittest.TestCase):
    ...
    def test_javascript_files_exist(self):
        ...
        # Only test for files that actually exist in the integrated application
        js_files = [
            ...
            '/static/js/demo-api-simulator.js',
            '/static/js/demo-config.js',
            '/static/js/generative-ui.js',
            '/static/js/trend_radar.js',
        ]
    ...
    def test_data_visualization(self):
        ...
        # Test existing visualization files
        response = self.app.get('/static/js/generative-ui.js')
        self.assertEqual(response.status_code, 200)

        # Test graph data integration
        response = self.app.get('/static/js/graph_data.js')
        self.assertEqual(response.status_code, 200)

        # Test trend radar visualization
        response = self.app.get('/static/js/trend_radar.js')
        self.assertEqual(response.status_code, 200)
