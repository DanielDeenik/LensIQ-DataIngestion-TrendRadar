...
class VectorStore:
    ...
    Uses MongoDB as the backend storage.
    """

    def __init__(self):
        """Initialize the vector store."""
        from ..database.adapters import get_database_adapter
    ...
    def add_item(self, item_id: str, embedding: List[float], metadata: Dict[str, Any], text: str) -> None:
        ...
        # Add to MongoDB
        self.db_adapter.insert_one(self.collection_name, doc_data)
    ...
    def get_item(self, item_id: str) -> Optional[Dict[str, Any]]:
        ...
        """
        result = self.db_adapter.find_one(self.collection_name,
                                          {"_id": item_id})
        return result
    ...
    def delete_item(self, item_id: str) -> None:
        ...
        Args:
            item_id: Unique identifier for the item
        """
        self.db_adapter.delete_one(self.collection_name, {"_id": item_id})
    ...
    def search(self, query_embedding: List[float], top_k: int = 5, filter_criteria: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        ...
        items = self.db_adapter.find(self.collection_name)
